...
if (isset($_POST['registro'])) {
    ...
    LEFT JOIN directorio ON usuario.documento=directorio.documento 
    ...
    if ($row) { // Si hay datos en la consulta
        ...
        try {
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p><b>Estudiante:</b> " . htmlspecialchars($nombre_estudiante, ENT_QUOTES, 'UTF-8') . "</p>
                        <p><b>Curso:</b> " . htmlspecialchars($curso, ENT_QUOTES, 'UTF-8') . "</p>
            ...
            echo "Error al enviar el correo. Revisa los logs.";
        }
    }
    
    header("Location:../ModDocente/observadores.php?mensaje=" . $mensaje);
