...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('IMG/morado.png'); /* Fondo con una imagen */
...
<body>
    ...
    <div class="form-container">
        <form action="#">
        <button type="submit" class="btn w-100" style="background-color: #b43eff; color: #FFFFFF;">REGISTRARSE</button>
 ...
 <!-- Documento -->
  ...
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z"/>
        ...
        <div class="form-group">
    <a href="listado.php" class="consu btn btn-block w-50 ms-auto" style="background-color: #5d00ff ; color: #ffffff;">Consultar</a>

    <a href="home.html" class="btn btn-block w-50 ms-auto" style="background-color: #8743ff; color: #ffffff;">Inicio</a>
</div>
    ...
    <div class="row"> 
        ...
        <div class="row">
        <h4 class="success-message">Registro exitoso</h4>
    </div>
    ...
    <div class="row">
            ...
            <a href="listado.php" class=" consu btn btn-info btn-block w-25 ms-auto">Consultar</a>
        </div>
    </div>
    ...
    <div class="row"> <br><br>
        ...
        <div class="col-md-4 text-center">
            <h4>SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry '0' for key 'PRIMARY'            </h4>
        </div>
